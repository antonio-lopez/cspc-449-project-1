...
#Update email
echo "Updating email...."
curl --location --request PUT 	'http://127.0.0.1:5000/api/v1/resources/users/email' \
--header 'Content-Type: application/json' \
...
curl --location --request PUT 	'http://127.0.0.1:5000/api/v1/resources/users/inc' \
--header 'Content-Type: application/json' \
...
curl --location --request PUT 	'http://127.0.0.1:5000/api/v1/resources/users/dec' \
--header 'Content-Type: application/json' \
--data-raw '{"username":"bob"}' \
--write-out '%{http_code}\n'
...
curl --location --request DELETE 	'http://127.0.0.1:5000/api/v1/resources/users/remove' \
--header 'Content-Type: application/json' \
--data-raw '{"username":"bob"}' \
--write-out '%{http_code}\n'
